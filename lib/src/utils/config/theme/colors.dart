...
class ColorCustom {
  final Color _green = const Color(0XFF44FF4D);
  final Color _greenMedium = const Color(0XFF44FF75);
  final Color _greenLight = const Color(0XFF44FF9E);
  final Color _blue = const Color(0XFF0056B8);
  final Color _blueMedium = const Color(0XFF1F87FF);
  final Color _blueLight = const Color(0XFF70B3FF);
  final Color _greyText = const Color(0xFFDBDBDB);
  final Color _greyTextDark = const Color(0xFF535353);
  ...
  Color get blueMedium => _blueMedium;
  Color get blueLight => _blueLight;
  Color get greyText => _greyText;
  Color get greyTextDark => _greyTextDark;

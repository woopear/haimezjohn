...
Route.group(() => {
  ...
  Route.group(() => {
    ...
    Route.get('/competences', async ({view}) => {
      return view.render('private/pages/competences', {title: 'Admin Profil John Haimez'})
    })

    // portfolio // TODO faire un groupe de portfolio pour inclure toute les routes
    Route.get('/portfolio', async ({view}) => {
      return view.render('private/pages/portfolio', {title: 'Admin Profil John Haimez'})
    })
    ...
    Route.get('/conditions_generales', async ({view}) => {
      return view.render('private/pages/conditions_generales', {title: 'Admin Profil John Haimez'})
    })
    ...
    Route.get('/mentions_legales', async ({view}) => {
      return view.render('private/pages/mentions_legales', {title: 'Admin Profil John Haimez'})
    })
  }).prefix('/admin')
}).prefix('/private')